...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    @Query("SELECT new br.erp.myerp.domain.client.dto.ClientResponseDTO(c.id, c.firstName, c.lastName, c.email, c.ddd, c.cellphone, c.birthday, c.cpf) FROM Client c")
